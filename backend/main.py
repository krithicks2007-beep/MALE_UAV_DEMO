...
# Add project root to sys.path so dummy_data_generator is importable
ROOT_DIR = Path(__file__).resolve().parent.parent
if str(ROOT_DIR) not in sys.path:
    sys.path.insert(0, str(ROOT_DIR))

from dummy_data_generator.generator import UAVDummyDataGenerator
from dummy_data_generator.config import GeneratorConfig, DEFAULT_CONFIG
from dummy_data_generator.ui import GENERATOR_HTML_CONTENT
